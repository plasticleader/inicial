...
'Are you sure you want to uninstall application "%s"?': '¿Está seguro que desea desinstalar la aplicación "%s"?',
'Asiganación Precios': 'Asiganación Precios',
'Asignación De Precios': 'Asignación De Precios',
'at': 'en',
...
'db': 'bdd',
'DB Model': 'Modelo BDD',
'Debe ingresar una imagen con formato PNG': 'Debe ingresar una imagen con formato PNG',
'Debe ingresar una imagen con formato PNG o JPG': 'Debe ingresar una imagen con formato PNG o JPG',
